...
htmlhelp_basename = 'biobb_wf_cmip_doc'
...
latex_documents = [
    (master_doc, 'biobb_wf_cmip.tex', u'biobb_wf_cmip Documentation',
...
man_pages = [
    (master_doc, 'biobb_wf_cmip', u'biobb_wf_cmip Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'biobb_wf_cmip', u'biobb_wf_cmip Documentation',
     author, 'biobb_wf_cmip', 'biobb_wf_cmip template building block',
     'Miscellaneous'),
]
